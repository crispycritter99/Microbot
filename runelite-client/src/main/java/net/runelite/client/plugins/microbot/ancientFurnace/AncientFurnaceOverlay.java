...
public class AncientFurnaceOverlay extends OverlayPanel {

    @Inject
    AncientFurnaceOverlay(AncientFurnacePlugin plugin)
    {
        super(plugin);
    ...
    public Dimension render(Graphics2D graphics) {
        try {
            ...
            panelComponent.getChildren().add(TitleComponent.builder()
                    .text("Micro AncientFurnace V1.0.0")
                    .color(Color.GREEN)
                    .build());
...
//            WorldPoint worldPoint =  Microbot.getClientThread().invoke(() -> Microbot.getClient().getLocalPlayer().getWorldLocation());
                ...
                long shardsGained=deayaltFragments-AncientFurnacePlugin.startingDaeyaltShard;
                long timeElapsed=AncientFurnacePlugin.initialTime-System.currentTimeMillis();
