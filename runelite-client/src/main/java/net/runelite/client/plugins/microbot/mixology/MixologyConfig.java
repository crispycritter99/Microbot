...
public interface MixologyConfig extends Config {
    ...
    @ConfigItem(
            keyName = "strategy",
            name = "Brewing Strategy",
            description = "<html>Which potions to skip each round:<br>" +
                    "<b>Full Orders</b> - brew everything (5290 avg)<br>" +
                    "<b>Reduce Triples</b> - skip AAA/MMM/LLL unless MAL present (5060 avg)<br>" +
                    "<b>Reduce Double Aga</b> - also skip AAM/AAL unless MAL (4851 avg)<br>" +
                    "<b>Full Order if Lye 4+</b> - above + override when 4+ Lye in draw (4678 avg)<br>" +
                    "<b>Optimised Point Distribution</b> - best overall strategy (4648 avg)</html>",
            position = 0,
            section = minigame
    )
    default Strategy strategy() {
        return Strategy.FULL_ORDERS;
    }
