...
@ConfigGroup(TitheFarmingFastConfig.GROUP)
public interface TitheFarmingFastConfig extends Config {
    ...
    default TitheFarmFastLanes Lanes() {
        return TitheFarmFastLanes.LANE_2_3;
    }
    @ConfigItem(
