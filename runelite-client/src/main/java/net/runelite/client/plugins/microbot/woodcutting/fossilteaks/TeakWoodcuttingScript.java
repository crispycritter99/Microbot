...
public class TeakWoodcuttingScript extends Script {
    ...
    public static WorldPoint initPlayerLoc(TeakWoodcuttingConfig config) {
    ...
    public boolean run(TeakWoodcuttingConfig config) {
    ...
    private void resetInventory(TeakWoodcuttingConfig config) {
    ...
    private void burnLog(TeakWoodcuttingConfig config) {
        WorldPoint fireSpot;
    ...
    private void fletchArrowShaft(TeakWoodcuttingConfig config) {
    ...
    private WorldPoint calculateReturnPoint(TeakWoodcuttingConfig config) {
        if (config.walkBack().equals(WoodcuttingWalkBack.LAST_LOCATION)) {
            return returnPoint;
        } else {
    ...
    private void walkBack(TeakWoodcuttingConfig config) {
