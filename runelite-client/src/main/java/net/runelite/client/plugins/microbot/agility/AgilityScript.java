...
public class AgilityScript extends Script {
    ...
    public static final Set<Integer> PORTAL_OBSTACLE_IDS = ImmutableSet.of(
            // Prifddinas portals
            NULL_36241,NULL_36240, NULL_36242, NULL_36243, NULL_36244, NULL_36245, NULL_36246
    );
//    public static final int[] portals = {36241,36240,36242,36243,36244,36245,36246};
...
//                    TileObject portal = Rs2GameObject.findObject(PORTAL_OBSTACLE_IDS.stream().collect(Collectors.toList()));
                    TileObject portal= Rs2GameObject.findObject(new Integer[] {36241,36240,36242,36243,36244,36245,36246});
