...
import net.runelite.client.plugins.microbot.orbcharger.OrbChargerLocalPlugin;
...
public class AirOrbScript extends Script {
    ...
    private final OrbChargerLocalPlugin plugin;
    ...
    @Inject
    public AirOrbScript(OrbChargerLocalPlugin plugin) {
        this.plugin = plugin;
    }
            ...
            try {
                ...
                switch (state) {
                    case BANKING:
                        ...
                        Rs2Bank.withdrawOne(ItemID.TABLET_PADDEWA);
