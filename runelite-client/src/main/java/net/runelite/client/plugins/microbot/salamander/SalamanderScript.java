...
//                        handleBreaks();
    ...
    private void handleIdleState() {
        try {
            ...
            if (Rs2Inventory.interact(10148,"release")||Rs2Inventory.interact(10147,"release")||Rs2Inventory.interact(10146,"release")||Rs2Inventory.interact(10149,"release")){sleep(Rs2Random.randomGaussian(500,3));}
