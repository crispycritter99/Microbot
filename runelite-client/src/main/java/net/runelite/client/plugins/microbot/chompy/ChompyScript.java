...
import net.runelite.client.plugins.microbot.falconry.FalconryPlugin;
...
//                        if (Rs2Npc.attack(ID_CHOMPY)) {
                            Rs2NpcModel npc = Rs2Npc.getAttackableNpcs("chompy").findFirst().orElse(null);
                if (npc != null) {
...
//                        if (ChompyPlugin.chompy!=null) {
////                            Rs2Npc.interact(ChompyPlugin.chompy, "attack");
//                            Rs2Npc.attack(ChompyPlugin.chompy);
//                            sleep(500);
//                            break;
//                        }
