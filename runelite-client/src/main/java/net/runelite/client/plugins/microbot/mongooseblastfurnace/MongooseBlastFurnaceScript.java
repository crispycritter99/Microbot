...
import net.runelite.client.plugins.microbot.mongooseblastfurnace.enums.Bars;
...
@Slf4j
public class MongooseBlastFurnaceScript extends Script {
    ...
    private final MongooseBlastFurnacePlugin plugin;
    private final MongooseBlastFurnaceConfig config;
    ...
    @Inject
    public MongooseBlastFurnaceScript(MongooseBlastFurnacePlugin plugin, MongooseBlastFurnaceConfig config) {
        this.plugin = plugin;
        this.config = config;
    }
