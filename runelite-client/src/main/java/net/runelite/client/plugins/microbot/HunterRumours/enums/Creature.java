...
import static net.runelite.client.plugins.microbot.HunterRumours.enums.Trap.*;
...
public enum Creature {
    ...
    @Getter
    private final net.runelite.client.plugins.microbot.HunterRumours.enums.Trap Trap;
