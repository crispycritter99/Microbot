...
public class ValeTotemBetaOverlay extends OverlayPanel {
    private final ValeTotemBetaPlugin plugin;
    
    @Inject
    ValeTotemBetaOverlay(ValeTotemBetaPlugin plugin) {
        super(plugin);
        this.plugin = plugin;
    ...
    public Dimension render(Graphics2D graphics) {
        try {
            ...
            panelComponent.getChildren().add(TitleComponent.builder()
                    .text("Vale Totems Bot v" + ValeTotemBetaPlugin.version)
                    .color(Color.CYAN)
                    .build());
            ...
            // Bot status
            ValeTotemBetaScript script = plugin.getScript();
