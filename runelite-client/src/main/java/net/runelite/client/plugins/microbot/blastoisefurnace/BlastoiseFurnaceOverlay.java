...
public class BlastoiseFurnaceOverlay extends OverlayPanel {
    @Inject
    BlastoiseFurnaceOverlay(BlastoiseFurnaceLocalPlugin plugin) {
        super(plugin);
    ...
    public Dimension render(Graphics2D graphics) {
        try {
            ...
            this.panelComponent.getChildren().add(TitleComponent.builder().text("Blastoise" + BlastoiseFurnaceLocalPlugin.version).color(Color.GREEN).build());
