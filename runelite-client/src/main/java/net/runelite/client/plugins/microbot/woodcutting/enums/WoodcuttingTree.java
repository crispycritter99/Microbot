...
public enum WoodcuttingTree {
    ...
    CAMPHOR("Camphor tree", "Camphor logs", ItemID.CAMPHOR_LOGS, 66, "Chop down"),
    IRONWOOD("Ironwood tree", "Ironwood logs", ItemID.IRONWOOD_LOGS, 80, "Chop down"),
    ROSEWOOD("Rosewood tree", "Rosewood logs", ItemID.ROSEWOOD_LOGS, 92, "Chop down"),
