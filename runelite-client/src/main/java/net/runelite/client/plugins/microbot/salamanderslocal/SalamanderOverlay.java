package net.runelite.client.plugins.microbot.salamanderslocal;
...
public class SalamanderOverlay extends OverlayPanel {
    ...
    private final SalamanderLocalConfig config;
    private final SalamanderLocalPlugin plugin;
    private final SalamanderLocalScript script;
    private int startingLevel = 0;

    @Inject
    public SalamanderOverlay(Client client, SalamanderLocalConfig config, SalamanderLocalPlugin plugin, SalamanderLocalScript script) {
        super(plugin);
        this.client = client;
        this.config = config;
        this.plugin = plugin;
    ...
    public Dimension render(Graphics2D graphics) {
        ...
        panelComponent.getChildren().add(LineComponent.builder()
                ...
                .right(String.valueOf(SalamanderLocalScript.SalamandersCaught))
                .leftColor(Color.WHITE)
