...
public class BrimhavenSpikeJumperOverlay extends OverlayPanel {

    @Inject
    BrimhavenSpikeJumperOverlay(BrimhavenSpikeJumperPlugin plugin)
    {
        super(plugin);
    ...
    public Dimension render(Graphics2D graphics) {
        try {
            ...
            panelComponent.getChildren().add(TitleComponent.builder()
                    .text("Brimhaven Spike Jumper V1.0.0")
                    .color(Color.GREEN)
                    .build());
...
//            WorldPoint worldPoint =  Microbot.getClientThread().invoke(() -> Microbot.getClient().getLocalPlayer().getWorldLocation());
                ...
                long shardsGained=deayaltFragments-BrimhavenSpikeJumperPlugin.startingDaeyaltShard;
                long timeElapsed=BrimhavenSpikeJumperPlugin.initialTime-System.currentTimeMillis();
