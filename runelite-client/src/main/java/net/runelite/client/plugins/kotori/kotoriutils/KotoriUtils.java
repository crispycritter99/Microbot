package net.runelite.client.plugins.kotori.kotoriutils;

import com.google.gson.*;
import com.google.inject.Provides;
import net.runelite.client.plugins.kotori.kotoriutils.gson.HookInfo;
import net.runelite.client.plugins.kotori.kotoriutils.gson.Hooks;
import net.runelite.client.plugins.kotori.kotoriutils.methods.MiscUtilities;
import net.runelite.client.plugins.kotori.kotoriutils.methods.PrayerInteractions;
import net.runelite.client.plugins.kotori.kotoriutils.rlapi.PrayerExtended;
import net.runelite.client.plugins.kotori.kotoriutils.rlapi.WidgetInfoPlus;
