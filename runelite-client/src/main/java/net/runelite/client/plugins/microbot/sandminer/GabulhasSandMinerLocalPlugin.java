...
@PluginDescriptor(
        name = PluginDescriptor.Gabulhas + "Sandstone miner Local",
        description = "",
        tags = {"GabulhasSandMiner", "Gabulhas"},
        version = GabulhasSandMinerLocalPlugin.version,
...
@Slf4j
public class GabulhasSandMinerLocalPlugin extends Plugin {
