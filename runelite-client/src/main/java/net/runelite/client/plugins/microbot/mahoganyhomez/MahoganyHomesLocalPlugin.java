...
public class MahoganyHomesLocalPlugin extends Plugin {
    ...
    public void onChatMessage(ChatMessage e) {
        ...
        if (message.startsWith("Mahogany\u00A0planks:")) {
