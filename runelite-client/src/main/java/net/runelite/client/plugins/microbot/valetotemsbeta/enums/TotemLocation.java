package net.runelite.client.plugins.microbot.valetotemsbeta.enums;
...
public enum TotemLocation {
    ...
    OAK_TOTEM_1(RouteType.OAK_TRIANGLE, 1, new WorldPoint(1346, 3319, 0), "Oak triangle site 6"),
    OAK_TOTEM_2(RouteType.OAK_TRIANGLE, 2, new WorldPoint(1370, 3375, 0), "Oak triangle site 7"),
    OAK_TOTEM_3(RouteType.OAK_TRIANGLE, 3, new WorldPoint(1398, 3329, 0), "Oak triangle site 8"),
    ...
    public enum RouteType {
        STANDARD(4, "Four Totems + Bank"),
        OAK_TRIANGLE(3, "Oak 6-7-8 Triangle"),
