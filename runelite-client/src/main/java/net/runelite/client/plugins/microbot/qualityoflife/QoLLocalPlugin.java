...
@PluginDescriptor(
        name = PluginDescriptor.See1Duck + "QoL Local",
        description = "Quality of Life Local Plugin",
        tags = {"QoL", "microbot"},
        version = QoLLocalPlugin.version,
...
@Slf4j
public class QoLLocalPlugin extends Plugin implements KeyListener {
