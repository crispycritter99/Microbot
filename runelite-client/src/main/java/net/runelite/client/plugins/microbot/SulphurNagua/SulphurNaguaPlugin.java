...
import net.runelite.client.plugins.microbot.SulphurNagua.bank.BankerScript;
import net.runelite.client.plugins.microbot.SulphurNagua.cannon.CannonScript;
import net.runelite.client.plugins.microbot.SulphurNagua.combat.*;
...
public class SulphurNaguaPlugin extends Plugin {
    ...
    @Inject
    private SulphurNaguaOverlay playerAssistOverlay;
    @Inject
    private SulphurNaguaInfoOverlay playerAssistInfoOverlay;
