...
@PluginDescriptor(
        ...
        version = SalamanderLocalPlugin.version,
...
public class SalamanderLocalPlugin extends Plugin {
    ...
    @Inject
    private SalamanderLocalConfig config;
    @Inject
    ...
    @Provides
    SalamanderLocalConfig provideConfig(ConfigManager configManager) {
