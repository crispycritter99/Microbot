...
public class FrostDragonKillerOverlay extends OverlayPanel {

    @Inject
    FrostDragonKillerOverlay(FrostDragonKillerPlugin plugin)
    {
        super(plugin);
    ...
    public Dimension render(Graphics2D graphics) {
        try {
            ...
            panelComponent.getChildren().add(TitleComponent.builder()
                    .text("Micro FrostDragonKiller V1.0.0")
                    .color(Color.GREEN)
                    .build());
...
//            WorldPoint worldPoint =  Microbot.getClientThread().invoke(() -> Microbot.getClient().getLocalPlayer().getWorldLocation());
                ...
                long shardsGained=deayaltFragments-FrostDragonKillerPlugin.startingDaeyaltShard;
                long timeElapsed=FrostDragonKillerPlugin.initialTime-System.currentTimeMillis();
