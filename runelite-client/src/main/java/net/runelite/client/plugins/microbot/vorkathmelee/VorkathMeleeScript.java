...
public class VorkathMeleeScript extends Script {
    public static String version = "1.3.9";
    public static VorkathMeleeConfig config;
    @Getter
    ...
    public boolean run(VorkathMeleeConfig config) {
        ...
        hasEquipment = false;
        hasInventory = false;
        VorkathMeleeScript.config = config;
            ...
            try {
                ...
                switch (state) {
                    ...
                    case WALK_TO_VORKATH_ISLAND:
                        ...
                        NPC torfin = Rs2Npc.getNpc(NpcID.TORFINN_10405);
                        if (torfin != null) {
     ...
     */
    private boolean checkSellingItems(VorkathMeleeConfig config) {
