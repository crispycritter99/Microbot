...
import net.runelite.client.plugins.microbot.aiofighterretro.enums.*;
...
public interface AIOFighterConfig extends Config {
    ...
    @ConfigItem(
            keyName = "UseThrall",
            name = "Use Thralls",
            description = "Summon Thralls to assist you",
            position = 10,
            section = combatSection
    )
    ...
    @ConfigItem(
            keyName = "ThrallType",
            name = "Type of Thrall",
            description = "Choose type of thrall",
            position = 11,
            section = combatSection
    )
    default ThrallType ThrallType() {
        return ThrallType.MAGE;
    }
