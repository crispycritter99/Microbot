package net.runelite.client.plugins.kotori.zulrahoverlay;

import com.google.common.base.Preconditions;
import com.google.inject.Provides;
import net.runelite.client.plugins.kotori.kotoriutils.KotoriUtils;
import net.runelite.client.plugins.kotori.kotoriutils.methods.MiscUtilities;
import net.runelite.client.plugins.kotori.kotoriutils.methods.NPCInteractions;
//import com.theplug.kotori.zulrahoverlay.overlays.*;
import net.runelite.client.plugins.kotori.zulrahoverlay.overlays.*;
import net.runelite.client.plugins.kotori.zulrahoverlay.rotationutils.RotationType;
import net.runelite.client.plugins.kotori.zulrahoverlay.rotationutils.ZulrahData;
import net.runelite.client.plugins.kotori.zulrahoverlay.rotationutils.ZulrahPhase;
