...
import net.runelite.client.plugins.microbot.shootingstar.ShootingStarLocalPlugin;
...
public class ShootingStarTableHeader extends JPanel
{
	...
	static
	{
		final BufferedImage arrowDown = ImageUtil.loadImageResource(ShootingStarLocalPlugin.class, "arrow.png");
