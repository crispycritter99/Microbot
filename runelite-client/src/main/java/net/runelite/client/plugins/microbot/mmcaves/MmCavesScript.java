...
public class MmCavesScript extends Script {
    private final MmCavesLocalPlugin plugin;

    @Inject
    public MmCavesScript(MmCavesLocalPlugin plugin) {
        this.plugin = plugin;
    }
    ...
    private final WorldPoint FIGHTING_TILE_A = new WorldPoint(2452, 9168, 1);
    private final WorldPoint FIGHTING_TILE_B = new WorldPoint(2453, 9167, 1);
    ...
    private void handleFight() {
        ...
        Rs2Prayer.toggle(Rs2PrayerEnum.PROTECT_MELEE, true);
        Rs2Prayer.toggle(Rs2PrayerEnum.DEAD_EYE, true);
...
//        if (attacked) walkBetweenTiles();
    ...
    private void stopAndLog() {
        ...
        Rs2Player.logout();
        Plugin PlayerAssistPlugin = Microbot.getPlugin(MmCavesLocalPlugin.class.getName());
