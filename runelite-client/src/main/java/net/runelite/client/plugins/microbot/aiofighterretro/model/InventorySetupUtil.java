package net.runelite.client.plugins.microbot.aiofighterretro.model;
...
import net.runelite.client.plugins.microbot.aiofighterretro.bank.BankerScript;
...
public class InventorySetupUtil {
    ...
    public static void determineInventorySetup(String monsterName) {
        ...
        if(config.currentInventorySetup() == null) {
            ...
            AIOFighterPluginLocal.setCurrentSlayerInventorySetup(config.defaultInventorySetup());
        }
        ...
        if (!Collections.disjoint(requiredSet, dragonWyvernItems)) {
            ...
            AIOFighterPluginLocal.setCurrentSlayerInventorySetup(config.dragonWyvernInventorySetup());
            return;
        }
        if (!Collections.disjoint(requiredSet, drakeItems)) {
            ...
            AIOFighterPluginLocal.setCurrentSlayerInventorySetup(config.drakeInventorySetup());
            return;
        }
        if (!Collections.disjoint(requiredSet, kuraskTurothItems)) {
            ...
            AIOFighterPluginLocal.setCurrentSlayerInventorySetup(config.kuraskTurothInventorySetup());
            return;
        }
        if (!Collections.disjoint(requiredSet, caveMiscItems)) {
            ...
            AIOFighterPluginLocal.setCurrentSlayerInventorySetup(config.caveMiscellaneousInventorySetup());
            return;
        }
