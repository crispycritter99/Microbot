package net.runelite.client.plugins.microbot.microhunter3t;
...
import net.runelite.client.plugins.microbot.salamanderslocal.SalamanderGroundItemLooter;
...
@PluginDescriptor(
        name = PluginDescriptor.Mocrosoft + "AutoHunter 3t Local",
        description = "Microbot AutoHunter plugin",
        tags = {"hunter", "microbot"},
        version = AutoHunterLocal3tPlugin.version,
...
@Slf4j
public class AutoHunterLocal3tPlugin extends Plugin {
    ...
    private SalamanderLocalScript script;
