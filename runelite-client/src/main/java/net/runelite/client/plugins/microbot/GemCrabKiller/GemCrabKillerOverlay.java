...
public class GemCrabKillerOverlay extends OverlayPanel {
    ...
    private final GemCrabKillerLocalPlugin plugin;
    private final ImageComponent image;

    @Inject
    GemCrabKillerOverlay(GemCrabKillerLocalPlugin plugin) {
        super(plugin);
    ...
    private BufferedImage getCrabImageFromResources() {
        try {
            var img = ImageUtil.loadImageResource(GemCrabKillerLocalPlugin.class, "GemStoneCrab.png");
