...
public class TitheFarmingFastOverlay extends OverlayPanel {
    TitheFarmingFastPlugin plugin;

    @Inject
    TitheFarmingFastOverlay(TitheFarmingFastPlugin plugin) {
        super(plugin);
        this.plugin = plugin;
    ...
    public Dimension render(Graphics2D graphics) {
        ...
        panelComponent.getChildren().add(LineComponent.builder()
                .left("Script State: ")
                .right(TitheFarmingFastScript.state.toString())
                .build());

        panelComponent.getChildren().add(LineComponent.builder()
                .left("Fruit per hour:")
                .right(String.valueOf(RateCalculator.getRatePerHour(TitheFarmingFastScript.fruits)))
                .build());
        ...
        panelComponent.getChildren().add(new ImageComponent(getImage(Objects.requireNonNull(TitheFarmMaterial.getSeedForLevel()).getFruitId(), TitheFarmingFastScript.fruits)));
