package net.runelite.client.plugins.microbot.aiofighterretro;
...
import net.runelite.client.plugins.microbot.aiofighterretro.cannon.CannonScript;
import net.runelite.client.plugins.microbot.aiofighterretro.combat.*;
import net.runelite.client.plugins.microbot.aiofighterretro.enums.PrayerStyle;
import net.runelite.client.plugins.microbot.aiofighterretro.enums.State;
import net.runelite.client.plugins.microbot.aiofighterretro.loot.LootScript;
...
@PluginDescriptor(
        ...
        version = AIOFighterPluginLocal.version,
...
@Slf4j
public class AIOFighterPluginLocal extends Plugin {
