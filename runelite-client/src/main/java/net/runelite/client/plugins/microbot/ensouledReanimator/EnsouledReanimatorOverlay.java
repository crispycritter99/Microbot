...
public class EnsouledReanimatorOverlay extends OverlayPanel {

    @Inject
    EnsouledReanimatorOverlay(EnsouledReanimatorPlugin plugin)
    {
        super(plugin);
    ...
    public Dimension render(Graphics2D graphics) {
        try {
            ...
            panelComponent.getChildren().add(TitleComponent.builder()
                    .text("Micro EnsouledReanimator V1.0.0")
                    .color(Color.GREEN)
                    .build());
...
//            WorldPoint worldPoint =  Microbot.getClientThread().invoke(() -> Microbot.getClient().getLocalPlayer().getWorldLocation());
                ...
                long shardsGained=deayaltFragments-EnsouledReanimatorPlugin.startingDaeyaltShard;
                long timeElapsed=EnsouledReanimatorPlugin.initialTime-System.currentTimeMillis();
