...
public class FastAIOFighterOverlay extends OverlayPanel {

    @Inject
    FastAIOFighterOverlay(FastAIOFighterPlugin plugin)
    {
        super(plugin);
    ...
    public Dimension render(Graphics2D graphics) {
        try {
            ...
            panelComponent.getChildren().add(TitleComponent.builder()
                    .text("Micro FastAIOFighter V1.0.0")
                    .color(Color.GREEN)
                    .build());
...
//            WorldPoint worldPoint =  Microbot.getClientThread().invoke(() -> Microbot.getClient().getLocalPlayer().getWorldLocation());
                ...
                long shardsGained=deayaltFragments-FastAIOFighterPlugin.startingDaeyaltShard;
                long timeElapsed=FastAIOFighterPlugin.initialTime-System.currentTimeMillis();
