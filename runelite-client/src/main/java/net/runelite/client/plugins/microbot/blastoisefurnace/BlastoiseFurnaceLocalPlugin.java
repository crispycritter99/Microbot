...
@PluginDescriptor(
        name = PluginDescriptor.Mocrosoft+"BlastoiseFurnace Local",
        description = "Storm's BlastoiseFurnace plugin",
        tags = {"microbot", "smithing", "bar", "ore", "blast", "furnace"},
        authors = {"Storm"},
        version = BlastoiseFurnaceLocalPlugin.version,
...
@Slf4j
public class BlastoiseFurnaceLocalPlugin extends Plugin {
