...
@PluginDescriptor(
        name = PluginDescriptor.LiftedMango + "Auto Gauntlet Local Prayer",
        description = "Auto Gauntlet Prayer Local plugin",
        tags = {"liftedmango", "Gauntlet", "pvm", "prayer", "money making", "auto", "boss"},
        version = AutoGauntletPrayerLocalPlugin.version,
...
public class AutoGauntletPrayerLocalPlugin extends Plugin {
