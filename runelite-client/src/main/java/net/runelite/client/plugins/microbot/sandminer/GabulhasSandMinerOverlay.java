...
public class GabulhasSandMinerOverlay extends OverlayPanel {
    ...
    private final GabulhasSandMinerLocalPlugin plugin;
//    private final ImageComponent image;

    @Inject
    GabulhasSandMinerOverlay(GabulhasSandMinerLocalPlugin plugin) {
        super(plugin);
...
//        image = new ImageComponent(getMiningImageFromResources());
    ...
    private BufferedImage getMiningImageFromResources() {
        try {
            var img = ImageUtil.loadImageResource(GabulhasSandMinerLocalPlugin.class,
    ...
    public Dimension render(Graphics2D graphics) {
        try {
            ...
            // Version footer
            panelComponent.getChildren().add(LineComponent.builder()
                    .right(GabulhasSandMinerLocalPlugin.version)
