...
public class MongooseBlastFurnaceOverlay extends OverlayPanel {
    @Inject
    MongooseBlastFurnaceOverlay(MongooseBlastFurnacePlugin plugin) {
        super(plugin);
    ...
    public Dimension render(Graphics2D graphics) {
        try {
            ...
            this.panelComponent.getChildren().add(TitleComponent.builder().text("Mongoose" + MongooseBlastFurnacePlugin.version).color(Color.GREEN).build());
