...
//                if (activeextractor!=null&& Harvestable&&Rs2Player.getAnimation()!=13599){
                ...
                }
                {
                    {
                        //squid
                        if (Rs2Inventory.contains("open seed box")&&Rs2Inventory.contains(false, "hemp", "cotton", "camphor", "frag","ironwood seed","toadflax seed","irit seed","avantoe seed","kwuarm seed","snapdragon seed","cadantine seed")) {
