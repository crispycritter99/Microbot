...
//                if (activeextractor!=null&& Harvestable&&Rs2Player.getAnimation()!=13599){
                ...
                }
                {
                    {
                        //squid
                        if (Rs2Inventory.contains("open seed box")&&Rs2Inventory.contains(false, "hemp", "cotton", "camphor", "frag","ironwood seed","toadflax","irit","avantoe","kwuarm","snapdragon","cadantine")) {
