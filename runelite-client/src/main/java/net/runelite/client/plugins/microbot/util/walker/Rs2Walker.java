...
//            Microbot.log(point.getRegionID()+"");
            // Handle wall and game objects
            TileObject object = null;
//            var tile = Rs2GameObject.getTiles(3).stream()
//                    .filter(x -> x.getWorldLocation().equals(Rs2WorldPoint.convertInstancedWorldPoint(point)))
...
//Microbot.log("null object");
            if (object == null) continue;
//            Microbot.log("yes object");
