...
public class InventoryUtils {
    ...
    public static final int BOW_STRING_SPOOL_ID = ItemID.BOW_STRING_SPOOL;
    ...
    public static int getBowCount() {
        int unstrung = Rs2Inventory.count(getBowId());
        if (config == null || config.logType() == ValeTotemBetaConfig.LogType.REDWOOD) {
            return unstrung;
        }
        return unstrung + Rs2Inventory.count(FletchingItemMapper.getStrungBowItemId(config.logType(), config.bowType()));
    }

    public static int getUnstrungBowCount() {
        return Rs2Inventory.count(getBowId());
    }

    public static boolean hasBowStringSpool() {
        return Rs2Inventory.hasItem(BOW_STRING_SPOOL_ID);
    }
     ...
     */
    public static int getLogBasketLogCount(net.runelite.client.plugins.microbot.valetotemsbeta.models.GameSession gameSession) {
     ...
     */
    public static boolean hasLogBasketSufficientLogs(net.runelite.client.plugins.microbot.valetotemsbeta.models.GameSession gameSession) {
     ...
     */
    public static boolean emptyLogBasket(net.runelite.client.plugins.microbot.valetotemsbeta.models.GameSession gameSession) {
        try {
            if (gameSession == null) {
...
//                    Rs2Dialogue.keyPressForDialogueOption("Yes");
     ...
     */
    public static boolean fillLogBasket(net.runelite.client.plugins.microbot.valetotemsbeta.models.GameSession gameSession) {
        try {
            if (gameSession == null) {
                System.err.println("GameSession is null - cannot track log basket");
                return false;
     ...
     */
    public static int getOptimalLogAmountForExtendedRoute(net.runelite.client.plugins.microbot.valetotemsbeta.models.GameSession gameSession) {
    ...
    public static int getOptimalLogBasketLogAmountForExtendedRoute(net.runelite.client.plugins.microbot.valetotemsbeta.models.GameSession gameSession) {
        // Reserve slots: knife, basket, optionally stamina potion
        int reservedSlots = isStaminaSupportEnabled() ? 3 : 2;
     ...
     */
    public static boolean hasEnoughMaterialsForExtendedRoute(net.runelite.client.plugins.microbot.valetotemsbeta.models.GameSession gameSession) {
     ...
     */
    public static boolean hasLogBasketSpace(net.runelite.client.plugins.microbot.valetotemsbeta.models.GameSession gameSession) {
     ...
     */
    public static int getLogBasketAvailableSpace(net.runelite.client.plugins.microbot.valetotemsbeta.models.GameSession gameSession) {
        if (!hasLogBasket() || gameSession == null) {
            return 0;
        }
     ...
     */
    public static boolean shouldEmptyLogBasket(net.runelite.client.plugins.microbot.valetotemsbeta.models.GameSession gameSession) {
