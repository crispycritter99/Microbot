...
//				Rs2Player.getLocalPlayer().getWorldArea()
		boolean hasLineOfSight = Rs2Player.getLocalPlayer().getWorldArea().hasLineOfSightTo(Microbot.getClient().getTopLevelWorldView(), this.getWorldPoint());
		switch (this)
		{
			case CRAFTING_GUILD:
