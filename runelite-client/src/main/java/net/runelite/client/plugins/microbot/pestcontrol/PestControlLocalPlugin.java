...
@PluginDescriptor(
        name = PluginConstants.MOCROSOFT + "Pest Control Local",
        description = "Supports all boats, portals, and shields.",
        tags = {"pest control", "minigames"},
        authors = { "Mocrosoft" },
        version = PestControlLocalPlugin.version,
...
@Slf4j
public class PestControlLocalPlugin extends Plugin {
    ...
    {
        if (PestControlScript.closestPortal.getKey().getHitPoints().getText().trim().equals("0")){
