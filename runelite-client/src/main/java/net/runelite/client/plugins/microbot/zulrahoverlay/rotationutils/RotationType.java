package net.runelite.client.plugins.microbot.zulrahoverlay.rotationutils;
...
import net.runelite.client.plugins.microbot.zulrahoverlay.constants.ZulrahType;
