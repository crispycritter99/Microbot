package net.runelite.client.plugins.microbot.chins;
...
import net.runelite.client.plugins.microbot.chins.scripts.AutoChinScript;
...
@PluginDescriptor(
        name = PluginDescriptor.Mocrosoft + "Chin Hunter",
...
public class ChinHunterPlugin extends Plugin {
    ...
    @Getter
    private static final Map<WorldPoint, HunterTrap> traps = new HashMap<>();
    @Getter
