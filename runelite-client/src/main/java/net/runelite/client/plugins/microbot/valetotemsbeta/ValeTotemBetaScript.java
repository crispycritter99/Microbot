...
import net.runelite.client.plugins.microbot.valetotemsbeta.enums.TotemLocation.RouteType;
import net.runelite.client.plugins.microbot.valetotemsbeta.handlers.*;
import net.runelite.client.plugins.microbot.valetotemsbeta.models.GameSession;
import net.runelite.client.plugins.microbot.valetotemsbeta.models.TotemProgress;
import net.runelite.client.plugins.microbot.valetotemsbeta.utils.InventoryUtils;
import org.apache.commons.lang3.RandomUtils;

import java.util.concurrent.TimeUnit;

public class ValeTotemBetaScript extends Script {

    private ValeTotemBetaConfig config;
    private GameSession gameSession;
    private boolean isRunning = false;

    public boolean run(ValeTotemBetaConfig config) {
        this.config = config;
    ...
    private void handleBankingState() {
        ...
        if (bankingSuccess) {
            ...
            RouteType currentRouteType = gameSession.getCurrentRouteType();
    ...
    private void handleFletchingState() {
        ...
        if (!FletchingHandler.stringAvailableBows()) {
            Microbot.log("Could not start spool stringing; decorations remain usable unstrung");
        }
