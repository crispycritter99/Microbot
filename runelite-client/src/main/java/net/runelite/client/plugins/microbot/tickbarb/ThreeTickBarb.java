...
import net.runelite.client.plugins.microbot.tickwc.ThreeTickBarbConfig;
import net.runelite.client.plugins.microbot.tickwc.ThreeTickBarbOverlay;
import net.runelite.client.plugins.microbot.tickwc.ThreeTickFishingState;
...
@PluginDescriptor(
        name = PluginDescriptor.Mocrosoft + "3T Barb Fishing",
